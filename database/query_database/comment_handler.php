...
<body>
        ...
        <div class="head">
            <p class="product-detail pt-5">
                ...
                <a href="#" id="favoriteButton">
                    <i class="far fa-bookmark" id="favoriteIcon" style='color:#ff9a62'></i> <!-- Biểu tượng bookmark -->
                </a>
            </p>
    ...
    <script>
        ...
        document.getElementById("favoriteButton").addEventListener("click", function () {
            ...
            var userId = <?php echo isset($_SESSION['user_id']) ? $_SESSION['user_id'] : 'null'; ?>; // Lấy user_id từ PHP hoặc set là null nếu không có
            ...
            xhr.send(JSON.stringify({ productId: productId, userId: userId }));
        });
    </script>
