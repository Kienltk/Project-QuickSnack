        ...
        <div class="container">
            <h1>
                <form action="" method="POST">
                    My Saved Recipes
                    <button class="btn" value="add_category" name="add_category" id="add_category">Add a
                        Category</button>
                </form>
            </h1>
            <h2>
                        ...
                        <div class="col-lg-3">
                            <div class="container mb-4 category_tab">
                                ...
                                <button class="edit-delete-button" data-bs-toggle="modal"
                                    data-bs-target="#editCategoryModal_<?php echo $row["user_category_id"] ?>" name="rename"
                                    id="<?php echo $row["user_category_id"] ?>"
                                ...
                                if ($j != 0) {
                                    ...
                                    ?>
                                    <button type="button" onclick="location.href='../../models/products/delete_category.php?id= " <?php echo $row["user_category_id"]; ?>'" class="edit-delete-button"
                                        id="deleteCategoryButton">Delete</button>
                                    <?php
                                }
                                ?>
                                <div class="modal fade" id="editCategoryModal_<?php echo $row["user_category_id"] ?>" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form name="rename_form" action="" method="POST"
                                                onsubmit="return characterLimit(<?php echo $row["user_category_id"]; ?>)">
                                                <div class="modal-body">
                                                    <input type="text" name="new_name"
                                                        id="editedCategoryInput<?php echo $row["user_category_id"]; ?>"
                                                        class="form-control" placeholder="Enter new category's name ..."
                                                        value="<?php echo $row["user_category_name"]; ?>">
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="submit" class="btn btn-primary" id="saveEditedCategoryButton"
                                                        name="save_change_<?php echo $row["user_category_id"]; ?>">Save
                                                        Changes</button>
                                                </div>
                                            </form>
                                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="container mb-4 category_tab">
                                ...
                                <button class="edit-delete-button" type="submit"
                                    onclick="location.href='../../models/products/delete_product_from_category.php?category_id=<?php echo $row["user_category_id"]; ?>&quick_snack_id=<?php echo $row["quick_snack_id"]; ?>&redirect=<?php echo $_GET["id"]; ?>'">Delete</button>
                            </div>
                        </div>
                        <?php
                        if ($i == 4) {
