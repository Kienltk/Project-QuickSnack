                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(images, function(index, image) {
                            $('.image-slider').append('<div class="image"><a href="../products/product_detail.php?quick_snack_id=' + image.quick_snack_id + '"><img src="' + image.address_img + '" class="img-fluid"></a></div>');
                        });
