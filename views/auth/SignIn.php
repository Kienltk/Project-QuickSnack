                ...
                <div class="col-lg-6 col-right">
                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <p class="mb-5 text-center text-muted">Don't have an account? <a href="signUp.php"
                                    class="text-muted">Sign up here</a></p>
                            ...
                            <div class="mb-4">
                                <button class="btn btn-facebook" type="button"><i class="fab fa-facebook"></i> Sign in
                                    with Facebook</button>
                                <button class="btn btn-google" type="button"><i class="fab fa-google"></i> Sign in with
                                    Google</button>
                            </div>
                        </form>
                    </div>
